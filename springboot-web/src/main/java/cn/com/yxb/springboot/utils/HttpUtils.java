 ...
 * Created on 2017/6/5.
 * <p>
 * Http接口：阿里云接口DEMO:免费和收费,收费标准请查询网站：阿里云API市场.
 *
 * @author bin
 */
...
//        String path = "/gps-to-weather";
        ...
        String method = "GET";
        String appcode = "APPCODE b8008210a9cc47b5bfbb4eb205a93a1d";
...
//        querys.put("lng", "116.2278");
        querys.put("location", "40.242266,116.2278");
        try {
            int i = 0;
            while (i < 10) {
                ...
                //获取response的body
                System.out.println("+++返回天气结果:++++==i====" + i + "" + result);
                i++;
            }
